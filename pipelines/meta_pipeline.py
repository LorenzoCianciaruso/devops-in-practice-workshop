...
pipeline = configurator\
	...
	.set_git_material(GitMaterial("https://github.com/LorenzoCianciaruso/devops-in-practice-workshop.git", branch="master", ignore_patterns=set(['pipelines/*']), invert_filter="True"))
...
configurator.save_updated_config()print "Updating Meta Pipeline..."
